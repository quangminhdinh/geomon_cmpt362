...
import com.group14.geomon.battle.ui.BattleActivity
import com.group14.geomon.data.FirebaseManager
import com.group14.geomon.data.Seeder
import com.group14.geomon.data.SpeciesRepository
import com.group14.geomon.data.db.AppDatabase
import com.group14.geomon.databinding.ActivityMainBinding
import com.group14.geomon.services.tracking.TrackingService
import com.group14.geomon.services.tracking.TrackingViewModel
import com.group14.geomon.ui.home.MenuDialogFragment
...
import com.group14.geomon.ui.chat.MonsterAI
import com.google.android.gms.maps.model.BitmapDescriptor
import kotlin.math.roundToInt
import com.group14.geomon.spawn.ItemSpawner
import com.group14.geomon.spawn.ItemSpawn
import android.os.Handler
import android.os.Looper
import com.bumptech.glide.Glide
import com.group14.geomon.ui.home.ChangeAvatarDialogFragment
import com.group14.geomon.ui.home.ChangeNameDialogFragment
import com.group14.geomon.data.DuelRequest
import com.group14.geomon.data.BattleState
...
class MainActivity : AppCompatActivity(), OnMapReadyCallback, ChangeAvatarDialogFragment.OnAvatarUpdatedListener, ChangeNameDialogFragment.OnNameUpdatedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.playerPanel.setOnClickListener {
            com.group14.geomon.ui.playerstats.PlayerStatsDialogFragment()
                .show(supportFragmentManager, "PlayerStatsDialog")
        }

        binding.btnInventory.setOnClickListener {
            startActivity(Intent(this, com.group14.geomon.ui.bag.BagActivity::class.java))
        }
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            ...
            launch(Dispatchers.Main) {
                ...
                binding.monsterPanel.setOnClickListener {
                    startActivity(Intent(this@MainActivity, com.group14.geomon.ui.pokedex.PokedexActivity::class.java))
                }
